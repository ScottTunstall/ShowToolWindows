...
#### View the tool windows you wish to stash (do this first!) 
  - First use Visual Studio's **View** menu to view the tool windows you'd like to stash. This brings them into the Stash/Restore tool window's "view" of the IDE.   

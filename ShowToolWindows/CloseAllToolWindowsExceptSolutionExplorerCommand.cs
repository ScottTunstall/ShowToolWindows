        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (EnvDTE.Window window in dte.Windows)
                {
                    try
                    {
                        if (window.Kind == WindowKindConsts.ToolWindowKind && window.ObjectKind != EnvDTE.Constants.vsWindowKindMainWindow && window.ObjectKind != EnvDTE.Constants.vsWindowKindSolutionExplorer)
                        {
                            window.Close();
                        }
                    }
